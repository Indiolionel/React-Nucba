        ...
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center justify-around sm:justify-around sm:w-88 w-44 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                ...
                >
                  ...
                  <svg class="h-6 w-6 text-white" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <circle cx="9" cy="19" r="2" />  <circle cx="17" cy="19" r="2" />  <path d="M3 3h2l2 12a3 3 0 0 0 3 2h7a3 3 0 0 0 3 -2l1 -7h-15.2" /></svg>
                  <span id="monto-carrito">{total}</span>

                </button>

                <a className='text-gray-200'> Login </a>
                <button
                  type="button"
